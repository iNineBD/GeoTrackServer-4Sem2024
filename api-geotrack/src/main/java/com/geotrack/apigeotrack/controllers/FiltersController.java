...
public class FiltersController {
    ...
    @PostMapping("/users")
    public ResponseEntity<ResponseUsers> filterUsers(@RequestBody RequestUser request) throws Exception {
    ...
    @PostMapping("/devices")
    public ResponseEntity<ResponseDevices> filterDevices(@RequestBody RequestDevice request) throws Exception {
