...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000/", "http://127.0.0.1:3000", "http://152.67.61.112:3000", "http://geotrack.ininetech.com.br/", "http://geotrack.ininetech.com.br", "https://geotrack.ininetech.com.br", "https://geotrack.ininetech.com.br/")); // Liste os domínios separadamente
        configuration.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS")); // Adiciona os métodos permitidos
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(customizer -> {
                    customizer
                            .requestMatchers(WHITE_LIST_URL).permitAll()  // URLs permitidas sem autenticação
